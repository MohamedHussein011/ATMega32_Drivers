...
#define Timer1Waveform_Mode     Fast_PWM_ICR1
...
#define Timer1CompareOutput_ModeChannelA     ClearOnCompare_SetAtTop

#define Timer1CompareOutput_ModeChannelB     NormalOperation

/* Clock Select - Prescaler
   Options:
		1: TimerNo_Prescalig       -   Clock Source
		2: TimerDiv_By_8           -   Division by 8
		3: TimerDiv_By_64          -   Division by 64
		4: TimerDiv_By_256         -   Division by 256
		5: TimerDiv_By_1024        -   Dvision by 1024
 */
...
#define Timer2Waveform_Mode     Normal
...
#define Timer2Prescaler_Select    Timer2Div_By_1024
...
#define Timer2_PreloadValue                   100
