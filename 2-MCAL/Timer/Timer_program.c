...
u8 vTimer0_Initpostbuild (EN_TimerMode_t ENcopy_mode, EN_TimerPrescaler_t ENcopy_prescaler)
{
	u8 u8Local_Error = OK;
 ...
 * return: Error State
 */
u8 u8Timer0_SetOverFlowPreload(u8 u8copy_tValue)
{
	u8 u8Local_Error = OK;
...
void vTimer0_SetCompMatchValue(u8 u8copy_tValue)
{
	OCR0 = u8copy_tValue;
}
...
u8  u8Timer0_SetCompareMatchMode(u8 u8copy_tValue)
{
...
void vTimer1_ICUSetEdge(u8 copy_u8EdgeId)
{
	switch(copy_u8EdgeId)
	{
...
void vTimer2_SetOverFlowPreload(u8 u8copy_tValue)
{
	TCNT2 = u8copy_tValue;
}
void vTimer2_SetCompMatchValue(u8 u8copy_tValue)
{
	OCR2 = u8copy_tValue;
}
...
u8  u8Timer2_SetCompareMatchMode(u8 u8copy_tValue)
{
	u8 u8Local_ErrorState = OK;
	switch(u8copy_tValue)
	{
