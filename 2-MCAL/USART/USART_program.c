...
#error "Wrong Clock Polarity Configuration"
	...
	SET_BIT(UCSRA,U2X);
	u16Local_UBBRvalue = (u16) ( (MC_Frequency / (u32) (8UL * BAUD_RATE)) - 1);

#elif DOUBLE_TRANSMISSION_SPEED == DISABLED
	CLR_BIT(UCSRA,U2X);
	u16Local_UBBRvalue = (u16) ( (MC_Frequency / (u32) (16UL * BAUD_RATE)) - 1);
...
#error "Wrong double transmission speed configuration"
	...
	u16Local_UBBRvalue = (u16) ( (MC_Frequency / (u32) (2UL * BAUD_RATE)) - 1);
...
u8 u8USART_ReceiveStringSynchronous(char * pu8Copy_string)
{
	u8 u8Local_ErrorState = OK;
	u32 u32Local_TimeoutCounter = 0;
	u8 u8Local_StringCounter = 0;
	u16 u16Local_StringSize = 1000;
