...
{
	u8 u8Local_ColumnArray[4] = {Keypad_COL0,Keypad_COL1, Keypad_COL2, Keypad_COL3};
	u8 u8Local_ROWArray[4] = {Keypad_ROW0,Keypad_ROW1, Keypad_ROW2, Keypad_ROW3};

	for(u8 u8Local_ColIterator = 0; u8Local_ColIterator<COLUMN_NUM; u8Local_ColIterator++)
	{
	...
	for(u8 u8Local_RowIterator = 0; u8Local_RowIterator<ROW_NUM; u8Local_RowIterator++)
	{
...
u8 u8Keypad_GetPressedKey (void)
{
	u8 u8Local_PressedKey = Keypad_NoPressedKey, u8Local_PinState;
	u8 u8Local_ColIterator, u8Local_RowIterator;
	static u8 u8Local_Array[4][4] = Keypad_Array;
	/*static is used to save these arrays in .data/.bss rather than stack as its size is small
	 *as we call this function alot
	 */
	static u8 u8Local_ColumnArray[4] = {Keypad_COL0,Keypad_COL1, Keypad_COL2, Keypad_COL3};
	static u8 u8Local_ROWArray[4] = {Keypad_ROW0,Keypad_ROW1, Keypad_ROW2, Keypad_ROW3};
